...
var configuracionesProduct = {
    ...
    //Mostrar botón para elegir las muestras gratis
            ...
            switch (contenedor) {
                ...
                case '.panel-installation-content':
                    ...
                    if (PDFElement.length) {
                        ...
                        contenedorMedidas.append('<div class="docBtn"><a href="' + PDF + '" target="_blank">VER MANUAL DE INSTALACIÓN</a></div>');
                    }
                break;
            }
